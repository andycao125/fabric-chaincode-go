...
nextRoot:
	for _, rootNum := range possibleRoots {
		...
		if err = root.isValid(rootCertificate, currentChain, opts); err != nil {
			continue
		}
...
nextIntermediate:
	for _, intermediateNum := range possibleIntermediates {
		...
		if err = intermediate.isValid(intermediateCertificate, currentChain, opts); err != nil {
			continue
		}
